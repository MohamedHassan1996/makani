    ...
    <div class="bg-[white]">
      <div class="flex justify-center w-11/12 md:w-4/5 m-auto flex-col py-24">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
            ...
            <a href="{{ route('dynamic.page.show',['slug' => "services", 'single_slug' => $product->id ]) }}" class="bg-[#fbfcf8] flex justify-start items-stretch flex-col max-w-[389px] grow shrink rounded-xl border-[3px] border-solid border-[#fbfcf8]">
