<div class="bg-[#FBFCF8] swiper-testmoniols overflow-hidden">
  <div class="swiper-wrapper">
    ...
    <div class="swiper-slide flex justify-start items-stretch flex-col pt-24 pb-40 w-11/12 md:w-4/5 m-auto">
        <h2 class="[font-family:Ping_AR_+_LT] text-4xl md:text-7xl font-bold leading-[50px] md:leading-[86px] text-[#333333] text-center md:">{{  app()->getLocale() == 'en' ? 'Customer Feedback' : 'بعض آراء عملائنا.' }}</h2>
